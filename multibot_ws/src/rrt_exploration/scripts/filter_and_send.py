...
from functions_mod import gridValue, informationGain
...
def node():
    ...
    global_costmap_topic = rospy.get_param(
        '~global_costmap_topic', '/move_base/global_costmap/costmap')          #Initially /move_base_node/global_costmap/costmap
